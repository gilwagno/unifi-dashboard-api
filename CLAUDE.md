...
8. ~~Frontend (Security.tsx, Events.tsx)~~ — APROVADO 47/50. PR #3 (aberta, aguardando aprovação humana).
9. **PRÓXIMO: e2e** — confirmar se Playwright já existe antes de configurar.
...
- PR #3 `test/frontend-security-events` — Vitest+Testing Library, Security.tsx, Events.tsx (+ fix de crash real), 47/50.
